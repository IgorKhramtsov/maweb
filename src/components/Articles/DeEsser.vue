<template>
  <Article title="DeEsser" year="2020">
    <p class="col-md-10">
      ...
      threshold and converting signal back by Inverse Fast Fourier Transform.
    </p>
    <div class="col-md-10">
    ...
    <p class="col-md-10">
      Resulted program have tow presets for man and womens vocal, two inputs for tuning
